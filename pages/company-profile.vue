           ...
           <div class="flex flex-col gap-5 lg:gap-7.5">
              ...
              <table class="table align-middle text-sm text-gray-500">
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  ...
                  <a class="flex items-center justify-center size-8 bg-light rounded-full border border-gray-300" href="#">
                   <img alt="product logo" class="light:hidden h-4" src="/media/brand-logos/apple-black.svg"/>
                  </a>
                 </div>
                </td>
                <td class="text-center">
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <a class="flex items-center justify-center size-8 bg-light rounded-full border border-gray-300" href="#">
                   <img alt="" class="size-4" src="/media/brand-logos/linkedin.svg"/>
                  </a>
                  <a class="flex items-center justify-center size-8 bg-light rounded-full border border-gray-300" href="#">
                   <img alt="" class="size-4" src="/media/brand-logos/twitch-purple.svg"/>
                  </a>
                  <a class="flex items-center justify-center size-8 bg-light rounded-full border border-gray-300" href="#">
                   <img alt="" class="dark:hidden size-4" src="/media/brand-logos/x.svg"/>
                   <img alt="" class="light:hidden size-4" src="/media/brand-logos/x-dark.svg"/>
                  </a>
                  <a class="flex items-center justify-center size-8 bg-light rounded-full border border-gray-300" href="#">
                   <img alt="" class="size-4" src="/media/brand-logos/dribbble.svg"/>
                  </a>
                 </div>
                </td>
                <td class="text-center">
             ...
             <div class="card-body lg:py-7.5 py-5">
              <div class="flex flex-wrap md:flex-nowrap gap-5 lg:gap-14">
               ...
               <div class="flex flex-wrap sm:flex-nowrap w-full gap-5 lg:gap-7.5">
                <img alt="" class="h-[35px] mt-2" src="/media/brand-logos/hex-lab.svg"/>
                <div class="flex bg-center max-w-72 lg:w-full p-5 lg:p-7 bg-no-repeat bg-[length:550px] border border-gray-300 rounded-xl border-dashed branding-bg">
                 <div class="flex flex-col place-items-center place-content-center text-center rounded-xl w-full">
                  ...
                  <a class="text-gray-900 text-xs font-medium hover:text-primary-active mb-px" href="html/demo1/network/user-cards/mini-cards.html">
                   Click or Drag & Drop
                  </a>
              ...
              <div class="scrollable-auto">
               <table class="table align-middle text-2sm text-gray-600">
                <thead class="bg-gray-100">
                 ...
                 <th class="text-right font-medium min-w-36">
                  Role
                 </th>
                 <th class="text-right font-medium min-w-32">
                  2FA
                 </th>
                 <th class="text-right font-medium min-w-20">
                  Joined
                 </th>
                 <th class="min-w-16">
                 </th>
                ...
                <tr>
                 ...
                 <td class="text-right text-gray-700 text-sm">
                  Today
                 </td>
                 <td class="text-right">
            ...
            <div class="card">
             ...
             <div class="card-body lg:py-7.5 py-5">
              ...
              <a class="btn btn-sm btn-light" href="#">
               <img alt="" class="size-4 shrink-0" src="/media/brand-logos/google.svg"/>
