<template>
  <div class="antialiased flex min-h-screen text-base text-gray-700 [--tw-page-bg:#f6f6f6] [--tw-page-bg-dark:var(--tw-coal-200)] [--tw-content-bg:var(--tw-light)] [--tw-content-bg-dark:var(--tw-coal-500)] [--tw-content-scrollbar-color:#e8e8e8] [--tw-header-height:58px] [--tw-sidebar-width:58px] [--tw-navbar-height:56px] bg-[--tw-page-bg] dark:bg-[--tw-page-bg-dark] lg:overflow-hidden">
       <!-- Page -->
  <!-- Base -->
    ...
    <header class="flex items-center fixed z-10 top-0 left-0 right-0 shrink-0 h-[--tw-header-height] bg-[--tw-page-bg] dark:bg-[--tw-page-bg-dark]" id="header">
     ...
     <div class="container-fluid flex justify-between items-stretch px-5 lg:ps-0 lg:gap-4" id="header_container">
      <div class="flex items-center">
       <div class="flex items-center justify-center lg:w-[--tw-sidebar-width] gap-2 shrink-0">
        ...
        <a href="html/demo3.html">
         <img class="dark:hidden min-h-[24px]" src="/media/app/mini-logo-primary.svg"/>
         <img class="hidden dark:block min-h-[24px]" src="/media/app/mini-logo-primary-dark.svg"/>
        </a>
       </div>
       <div class="flex items-center">
        ...
        <div class="menu menu-default" data-menu="true">
         <div class="menu-item" data-menu-item-offset="0, 10px" data-menu-item-placement="bottom-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="hover">
          ...
          <div class="menu-dropdown w-48 py-2">
           <div class="menu-item">
            <a class="menu-link" href="html/demo3/public-profile/profiles/default.html" tabindex="0">
           ...
           <div class="menu-item active">
            <a class="menu-link" href="html/demo3.html" tabindex="0">
             <span class="menu-icon">
           ...
           <div class="menu-item">
            <a class="menu-link" href="html/demo3/network/get-started.html" tabindex="0">
             <span class="menu-icon">
           ...
           <div class="menu-item">
            <a class="menu-link" href="html/demo3/authentication/get-started.html" tabindex="0">
             <span class="menu-icon">
      ...
      <div class="flex items-center gap-1.5 lg:gap-3.5">
       <a class="btn btn-xs btn-primary" href="html/demo3/account/home/get-started.html">
        Get Started
       </a>
       <div class="flex items-center gap-1.5">
        <button class="btn btn-icon btn-icon-lg size-8 text-gray-600 hover:text-primary" data-modal-toggle="#search_modal">
        ...
        <div class="dropdown" data-dropdown="true" data-dropdown-offset="10px, 10px" data-dropdown-placement="bottom-end" data-dropdown-trigger="click|lg:click">
         <button class="dropdown-toggle btn btn-icon btn-icon-lg size-8 text-gray-600 hover:text-primary [dropdown-open:text-primary">
               ...
               <div class="flex flex-col gap-2.5 grow">
                ...
                <div class="flex items-center gap-2.5">
                 <div class="card shadow-none flex flex-col gap-3.5 bg-light-active w-40">
                  <div class="bg-cover bg-no-repeat card-rounded-t shrink-0 h-24" style="background-image: url('/media/images/600x600/6.jpg')">
                  </div>
                 ...
                 <div class="card shadow-none flex flex-col gap-3.5 bg-light-active w-40">
                  <div class="bg-cover bg-no-repeat card-rounded-t shrink-0 h-24" style="background-image: url('/media/images/600x600/1.jpg')">
                  </div>
                  <div class="px-2.5 pb-2">
                   <a class="font-medium block text-gray-700 hover:text-primary text-xs leading-4 mb-0.5" href="#">
               ...
               <div class="menu-item" data-menu-item-offset="0, 10px" data-menu-item-placement="bottom-end" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:hover">
                ...
                <div class="menu-dropdown menu-default w-full max-w-[175px]" data-menu-dismiss="true">
                 ...
                 <div class="menu-item" data-menu-item-offset="-15px, 0" data-menu-item-placement="right-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:hover">
                  ...
                  <div class="menu-dropdown menu-default w-full max-w-[175px]">
                   <div class="menu-item">
                    <a class="menu-link" href="html/demo3/account/members/import-members.html">
                     <span class="menu-icon">
                 ...
                 <div class="menu-item">
                  <a class="menu-link" href="html/demo3/account/security/privacy-settings.html">
                   <span class="menu-icon">
       ...
       <div class="menu" data-menu="true">
        <div class="menu-item" data-menu-item-offset="0px, 9px" data-menu-item-placement="bottom-end" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:click">
         ...
         <div class="menu-dropdown menu-default light:border-gray-300 w-screen max-w-[250px]">
          ...
          <div class="flex flex-col">
           <div class="menu-item">
            <a class="menu-link" href="html/demo3/public-profile/profiles/default.html">
             <span class="menu-icon">
           ...
           <div class="menu-item" data-menu-item-offset="-50px, 0" data-menu-item-placement="left-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:hover">
            ...
            <div class="menu-dropdown menu-default light:border-gray-300 w-full max-w-[220px]">
             <div class="menu-item">
              <a class="menu-link" href="html/demo3/account/home/get-started.html">
               <span class="menu-icon">
      ...
      <div class="pb-6">
       ...
       <div class="container-fluid flex items-center justify-between flex-wrap gap-3">
        ...
        <div class="flex items-center gap-1">
         <a class="btn btn-light btn-sm" href="html/demo3/public-profile/profiles/default.html">
          View Profile
         </a>
        </div>
       </div>
         ...
         <div class="flex flex-col gap-5 lg:gap-7.5">
          <div class="card">
           <div class="card-body px-10 py-7.5 lg:pr-12.5">
            <div class="flex flex-wrap xl:flex-nowrap items-center justify-between gap-6 md:gap-10 p-2.5">
             ...
             <div class="shrink-0">
              <img alt="image" class="dark:hidden max-h-36" src="/media/illustrations/5.svg"/>
              <!-- <img alt="image" class="light:hidden max-h-36" src="/media/illustrations/5-dark.svg"/> -->
             </div>
            </div>
           </div>
          ...
          <div class="card">
           ...
           <div class="card-group flex items-center justify-between py-4 gap-2.5">
            ...
            <div class="flex items-center gap-2.5">
             <a class="btn btn-sm btn-light btn-danger btn-outline" href="#">
              Disable all
             </a>
             <a class="btn btn-sm btn-light btn-outline" href="#">
              Enable all
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <a class="flex items-center justify-center size-8 bg-light rounded-full border border-gray-300" href="#">
                 <img alt="" class="size-4" src="/media/brand-logos/google.svg"/>
                </a>
                <a class="flex items-center justify-center size-8 bg-light rounded-full border border-gray-300" href="#">
                 <img alt="" class="size-4" src="/media/brand-logos/facebook.svg"/>
                </a>
                <a class="flex items-center justify-center size-8 bg-light rounded-full border border-gray-300" href="#">
                 <img alt="" class="dark:hidden size-4" src="/media/brand-logos/apple-black.svg"/>
                 <img alt="" class="light:hidden size-4" src="/media/brand-logos/apple-white.svg"/>
                </a>
               </div>
              </td>
              <td class="text-right">
           ...
           <div class="card-header">
            ...
            <div class="menu" data-menu="true">
             <div class="menu-item" data-menu-item-offset="0, 10px" data-menu-item-placement="bottom-end" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:click">
              ...
              <div class="menu-dropdown menu-default w-full max-w-[175px]" data-menu-dismiss="true">
               <div class="menu-item">
                <a class="menu-link" href="html/demo3/account/home/settings-plain.html">
                 <span class="menu-icon">
           ...
           <div class="card-table scrollable-x-auto">
            <div class="scrollable-auto">
             <table class="table align-middle text-gray-700 text-sm">
              <thead>
               <tr>
                <th class="text-left min-w-48">
                 Name
                </th>
                <th class="text-right min-w-20">
                 Location
                </th>
                <th class="text-right min-w-20">
                 Recent activity
                </th>
                <th class="text-right w-[70px]">
                </th>
               </tr>
              </thead>
              <tbody>
               <tr>
                <td>
                 <div class="flex items-center grow gap-2.5">
                  <div class="">
                   <img class="rounded-full size-9 shrink-0" src="/media/avatars/300-3.png"/>
                  </div>
                  <div class="flex flex-col gap-0.5">
                ...
                <td class="text-right text-gray-700 font-normal">
                 New Zealand
                </td>
                <td class="text-right text-gray-700 font-normal">
                 Current session
               ...
               <tr>
                <td>
                 <div class="flex items-center grow gap-2.5">
                  <div class="">
                   <img class="rounded-full size-9 shrink-0" src="/media/avatars/300-1.png"/>
                  </div>
                  <div class="flex flex-col gap-0.5">
                   <a class="text-sm font-medium text-gray-900 hover:text-primary-actives" href="#">
                    Esther Howard
               ...
               <tr>
                <td>
                 <div class="flex items-center grow gap-2.5">
                  <div class="">
                   <img class="rounded-full size-9 shrink-0" src="/media/avatars/300-11.png"/>
                  </div>
                  <div class="flex flex-col gap-0.5">
                   <a class="text-sm font-medium text-gray-900 hover:text-primary-actives" href="#">
                    Jacob Jones
               ...
               <tr>
                <td>
                 <div class="flex items-center grow gap-2.5">
                  <div class="">
                   <img class="rounded-full size-9 shrink-0" src="/media/avatars/300-2.png"/>
                  </div>
                  <div class="flex flex-col gap-0.5">
                   <a class="text-sm font-medium text-gray-900 hover:text-primary-actives" href="#">
                    Cody Fisher
               ...
               <tr>
                <td>
                 <div class="flex items-center grow gap-2.5">
                  <div class="">
                   <img class="rounded-full size-9 shrink-0" src="/media/avatars/300-5.png"/>
                  </div>
                  <div class="flex flex-col gap-0.5">
                   <a class="text-sm font-medium text-gray-900 hover:text-primary-actives" href="#">
                    Leslie Alexander
               ...
               <tr>
                <td class="min-w-48 w-48">
                 <div class="flex items-center gitem gap-2.5">
                  <img alt="image" class="h-6" src="/media/brand-logos/chrome.svg"/>
                  <div class="flex flex-col">
                   ...
                   <div class="flex gap-1.5">
                    ...
                    <img alt="image" class="h-3.5 rounded-full" src="/media/flags/spain.svg"/>
                   </div>
                  </div>
                 </div>
                </td>
                ...
                <td class="!pr-7.5 min-w-16 text-right">
                 ...
                 <div class="flex items-center gitem gap-2.5">
                  ...
                  <div class="flex flex-col">
                   ...
                   <div class="flex gap-1.5">
                    ...
                    <img alt="image" class="h-3.5 rounded-full" src="/media/flags/france.svg"/>
                   </div>
                  </div>
                 </div>
                </td>
           ...
           <div class="flex flex-wrap items-center justify-between gap-5">
            <div class="flex items-center gap-2.5">
             ...
             39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
              ...
              <div class="absolute leading-none left-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4">
               <img alt="" class="dark:hidden h-5" src="/media/brand-logos/apple-black.svg"/>
               <img alt="" class="light:hidden h-5" src="/media/brand-logos/apple-white.svg"/>
              </div>
             </div>
             <div class="flex flex-col gap-0.5">
           ...
           <div class="flex flex-wrap items-center justify-between gap-5">
            <div class="flex items-center gap-2.5">
             ...
             39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
              ...
              <div class="absolute leading-none left-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4">
               <img alt="" class="h-5" src="/media/brand-logos/android.svg"/>
              </div>
             </div>
             <div class="flex flex-col gap-0.5">
              <span class="leading-none font-medium text-base text-gray-900">
...
useHead({
  ...
  link: [
    ...
    // {
    //   rel: 'stylesheet',
    //   href: 'vendors/keenicons/styles.bundle.css', // Point to the file in the 'public' folder
    // },
  ],
});
</script>
