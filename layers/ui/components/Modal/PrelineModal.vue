...
<div class="flex flex-grow">
    <h2>UI-MODAL-PRELINEMODAL COMPONENT </h2>
xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx

    <div id="hs-scale-animation-modal" class="  size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto pointer-events-none" role="dialog" tabindex="-1" >
