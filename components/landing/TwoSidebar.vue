<template>
  ...
  <div>
    ...
    <div class="hidden lg:fixed lg:inset-y-0 lg:left-0 lg:z-50 lg:block lg:w-20 lg:overflow-y-auto lg:bg-gray-900 lg:pb-4">
      ...
      <nav class="mt-8">
        <ul role="list" class="flex flex-col items-center space-y-1">
          <li v-for="item in navigation" :key="item.name">
            <a :href="item.href" :class="[item.current ? 'bg-gray-800 text-gray-900' : 'text-slate-900 hover:bg-gray-800 hover:text-white', 'group flex gap-x-3 rounded-md p-3 text-sm font-semibold leading-6']">
              <component :is="item.icon" class="h-6 w-6 shrink-0" aria-hidden="true" />
    ...
    <aside class="fixed bottom-0 left-20 top-16 hidden w-72 overflow-y-auto border-r border-gray-200 px-4 py-6 sm:px-6 lg:px-8 xl:block">
