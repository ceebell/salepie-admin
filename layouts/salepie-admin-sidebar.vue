<template>
    <div class="min-h-screen text-gray-700 [--tw-page-bg:#F6F6F9] [--tw-page-bg-dark:var(--tw-coal-200)] [--tw-content-bg:var(--tw-light)] [--tw-content-bg-dark:var(--tw-coal-500)] [--tw-content-scrollbar-color:#e8e8e8] [--tw-header-height:60px] [--tw-sidebar-width:90px] bg-[--tw-page-bg] dark:bg-[--tw-page-bg-dark] lg:overflow-hidden">
        <!-- Base -->
        <div class="flex flex-col grow">
            ...
            <header class="flex lg:hidden items-center fixed z-10 top-0 start-0 end-0 shrink-0 bg-[--tw-page-bg] dark:bg-[--tw-page-bg-dark] h-[--tw-header-height]" id="header">
                ...
                <img class="dark:hidden min-h-[30px]" src="/media/app/mini-logo-gray.svg"/>
                <img class="hidden dark:block min-h-[30px]" src="/media/app/mini-logo-gray-dark.svg"/>
                </a>
            ...
            <div class="flex grow flex-col pt-[--tw-header-height] lg:pt-0">
                <!-- Sidebar -->
                <div class="fixed top-0 bottom-0 z-20 hidden lg:flex items-stretch shrink-0 w-[--tw-sidebar-width] bg-[--tw-page-bg] dark:bg-[--tw-page-bg-dark]" data-drawer="true" data-drawer-class="drawer drawer-start flex top-0 bottom-0" data-drawer-enable="true|lg:false" id="sidebar">
                    <!-- Sidebar Primary -->
                    <div class="flex flex-col items-stretch shrink-0 gap-5 py-5 w-[70px] border-e border-gray-300 dark:border-gray-200" id="sidebar_primary">
                    ...
                    <div class="scrollable-y-hover grow gap-2.5 shrink-0 flex ps-4 flex-col" data-scrollable="true" data-scrollable-dependencies="#sidebar_primary_header,#sidebar_primary_footer" data-scrollable-height="auto" data-scrollable-offset="80px" data-scrollable-wrappers="#sidebar_primary_content">
                    <a class="btn btn-icon btn-icon-xl rounded-md size-9 border border-transparent text-gray-600 hover:bg-light hover:text-primary hover:border-gray-200 [.active&]:bg-light [.active&]:text-primary [.active&]:border-gray-200" data-tooltip="" data-tooltip-placement="right" href="html/demo4.html">
                    ...
                    <a class="btn btn-icon btn-icon-xl rounded-md size-9 border border-transparent text-gray-600 hover:bg-light hover:text-primary hover:border-gray-200 [.active&]:bg-light [.active&]:text-primary [.active&]:border-gray-200" data-tooltip="" data-tooltip-placement="right" href="html/demo4/public-profile/profiles/default.html">
                        <span class="menu-icon">
                    ...
                    <a class="btn btn-icon btn-icon-xl rounded-md size-9 border border-transparent text-gray-600 hover:bg-light hover:text-primary hover:border-gray-200 [.active&]:bg-light [.active&]:text-primary [.active&]:border-gray-200 active" data-tooltip="" data-tooltip-placement="right" href="html/demo4/account/home/get-started.html">
                        <span class="menu-icon">
                    ...
                    <a class="btn btn-icon btn-icon-xl rounded-md size-9 border border-transparent text-gray-600 hover:bg-light hover:text-primary hover:border-gray-200 [.active&]:bg-light [.active&]:text-primary [.active&]:border-gray-200" data-tooltip="" data-tooltip-placement="right" href="html/demo4/network/get-started.html">
                        <span class="menu-icon">
                    ...
                    <a class="btn btn-icon btn-icon-xl rounded-md size-9 border border-transparent text-gray-600 hover:bg-light hover:text-primary hover:border-gray-200 [.active&]:bg-light [.active&]:text-primary [.active&]:border-gray-200" data-tooltip="" data-tooltip-placement="right" href="html/demo4/authentication/get-started.html">
                        <span class="menu-icon">
                    ...
                    <a class="btn btn-icon btn-icon-xl rounded-md size-9 border border-transparent text-gray-600 hover:bg-light hover:text-primary hover:border-gray-200 [.active&]:bg-light [.active&]:text-primary [.active&]:border-gray-200" data-tooltip="" data-tooltip-placement="right" href="html/demo4/account/billing/plans.html">
                        <span class="menu-icon">
                    ...
                    <a class="btn btn-icon btn-icon-xl rounded-md size-9 border border-transparent text-gray-600 hover:bg-light hover:text-primary hover:border-gray-200 [.active&]:bg-light [.active&]:text-primary [.active&]:border-gray-200" data-tooltip="" data-tooltip-placement="right" href="html/demo4/account/security/security-log.html">
                        <span class="menu-icon">
                    ...
                    <a class="btn btn-icon btn-icon-xl rounded-md size-9 border border-transparent text-gray-600 hover:bg-light hover:text-primary hover:border-gray-200 [.active&]:bg-light [.active&]:text-primary [.active&]:border-gray-200" data-tooltip="" data-tooltip-placement="right" href="html/demo4/account/notifications.html">
                        <span class="menu-icon">
                    ...
                    <a class="btn btn-icon btn-icon-xl rounded-md size-9 border border-transparent text-gray-600 hover:bg-light hover:text-primary hover:border-gray-200 [.active&]:bg-light [.active&]:text-primary [.active&]:border-gray-200" data-tooltip="" data-tooltip-placement="right" href="html/demo4/account/members/roles.html">
                        <span class="menu-icon">
                        <i class="ki-filled ki-code">
                        </i>
                        </span>
                    ...
                    <a class="btn btn-icon btn-icon-xl rounded-md size-9 border border-transparent text-gray-600 hover:bg-light hover:text-primary hover:border-gray-200 [.active&]:bg-light [.active&]:text-primary [.active&]:border-gray-200" data-tooltip="" data-tooltip-placement="right" href="html/demo4/account/api-keys.html">
                        <span class="menu-icon">
                    ...
                    <div class="dropdown" data-dropdown="true" data-dropdown-offset="10px, 15px" data-dropdown-placement="right-end" data-dropdown-trigger="click|lg:click">
                        ...
                        <div class="flex items-center justify-between flex-wrap gap-2 px-5">
                            ...
                            <div class="menu-dropdown menu-default w-full max-w-[175px]" data-menu-dismiss="true">
                                <div class="menu-item">
                                <a class="menu-link" href="html/demo4/account/members/teams.html">
                                <span class="menu-icon">
                                <i class="ki-filled ki-users">
                                </i>
                                </span>
                                ...
                                <div class="menu-item">
                                <a class="menu-link" href="html/demo4/account/members/import-members.html">
                                    <span class="menu-icon">
                                ...
                                <div class="menu-item">
                                <a class="menu-link" href="html/demo4/account/security/privacy-settings.html">
                                <span class="menu-icon">
                    ...
                    <div class="dropdown" data-dropdown="true" data-dropdown-offset="-10px, 15px" data-dropdown-placement="right-end" data-dropdown-trigger="click|lg:click">
                        ...
                        <a class="btn btn-sm btn-light justify-center" href="html/demo4/account/api-keys.html">
                        Go to Apps
                        </a>
                        </div>
                        </div>
                    ...
                    <div class="menu-item" data-menu-item-offset="-10px, 15px" data-menu-item-placement="right-end" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:click">
                        ...
                        <img alt="" class="size-8 rounded-full justify-center border border-gray-500 shrink-0" src="/media/avatars/gray/5.png">
                        </img>
                        </div>
                        ...
                        <img alt="" class="size-9 rounded-full border-2 border-success" src="/media/avatars/300-2.png">
                            ...
                            <a class="text-xs text-gray-600 hover:text-primary font-medium leading-none" href="html/demo4/account/home/get-started.html">
                            c.fisher@gmail.com
                            </a>
                            </div>
                        </img>
                        ...
                        <div class="flex flex-col">
                        <div class="menu-item">
                        <a class="menu-link" href="html/demo4/public-profile/profiles/default.html">
                            <span class="menu-icon">
                        ...
                        <div class="menu-item">
                        <a class="menu-link" href="html/demo4/account/home/user-profile.html">
                            <span class="menu-icon">
                        ...
                        <div class="menu-dropdown menu-default light:border-gray-300 w-full max-w-[220px]">
                            <div class="menu-item">
                            <a class="menu-link" href="html/demo4/account/home/get-started.html">
                            <span class="menu-icon">
                            ...
                            <div class="menu-item">
                            <a class="menu-link" href="html/demo4/account/security/overview.html">
                            <span class="menu-icon">
                            ...
                            <div class="menu-item">
                            <a class="menu-link" href="html/demo4/account/integrations.html">
                            <span class="menu-icon">
                        ...
                        <a class="btn btn-sm btn-light justify-center" href="html/demo4/authentication/classic/sign-in.html">
                            Log out
                        </a>
                        </div>
                        </div>
                ...
                <!-- End of Sidebar -->
                <!-- Main -->
                <main class="scrollable-y-auto [scrollbar-width:auto] light:[--tw-scrollbar-thumb-color:var(--tw-content-scrollbar-color)] flex flex-col grow rounded-xl bg-[--tw-content-bg] dark:bg-[--tw-content-bg-dark] border border-gray-300 dark:border-gray-200 lg:ms-[--tw-sidebar-width] pt-5 mt-0 lg:mt-5 m-5" data-scrollable="true" data-scrollable-height="false|lg:auto" data-scrollable-offset="40px" role="content">
                    <!-- Container -->
                    ...
                    <div class="card">
                        ...
                        <img alt="" class="size-[70px]" src="/media/brand-logos/cloud-one.svg">
                    ...
                    <div class="card grow">
                        ...
                        <tr>
                            ...
                            <td class="flex items-center gap-2.5 text-sm text-gray-800">
                            <img alt="" class="w-10 shrink-0" src="/media/brand-logos/visa.svg"/>
                            Ending 3604
                            </td>
                        </tr>
                        <tr>
                    ...
                    <div class="card grow">
                        ...
                        <div class="flex items-center justify-between border border-gray-200 rounded-xl gap-2 px-4 py-4 bg-secondary-clarity">
                        <div class="flex items-center gap-3.5">
                            <img alt="" class="w-10 shrink-0" src="/media/brand-logos/ideal.svg"/>
                            <div class="flex flex-col">
                            <a class="text-sm font-medium text-gray-900 hover:text-primary-active mb-px" href="#">
                            Jason Tatum
                            </a>
                        ...
                        <div class="flex items-center justify-between border border-gray-200 rounded-xl gap-2 px-4 py-4 bg-secondary-clarity">
                        <div class="flex items-center gap-3.5">
                            <img alt="" class="w-10 shrink-0" src="/media/brand-logos/paypal.svg"/>
                            <div class="flex flex-col">
                            <a class="text-sm font-medium text-gray-900 hover:text-primary-active mb-px" href="#">
                            Jason Tatum
                            </a>
                    ...
                    <div class="card">
                        ...
                        <tr>
                            ...
                            <td class="text-sm text-gray-800 lg:text-right">
                            6 Aug, 2024
                            </td>
                            <td class="text-sm text-gray-800 lg:text-right">
                            $24.00
                    ...
                    <div class="grid lg:grid-cols-2 gap-5 lg:gap-7.5">
                        ...
                        <img alt="image" class="dark:hidden max-h-[150px]" src="/media/illustrations/2.svg"/>
                        <img alt="image" class="light:hidden max-h-[150px]" src="/media/illustrations/2-dark.svg"/>
                        </div>
                        </div>
                        <div class="card-footer justify-center">
                        <a class="btn btn-link" href="">
                        ...
                        <img alt="image" class="dark:hidden max-h-[150px]" src="/media/illustrations/4.svg"/>
                        <img alt="image" class="light:hidden max-h-[150px]" src="/media/illustrations/4-dark.svg"/>
                        </div>
                        </div>
                        <div class="card-footer justify-center">
                        <a class="btn btn-link" href="">
